        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="font-serif text-3xl text-gray-900 leading-tight">
                    {{ __('Create') }} <span class="italic text-primary-500">New Category</span>
                </h2>
                <p class="text-xs text-gray-500 uppercase tracking-widest mt-1">Design a new theme for your library
                    shelf.</p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-100 shadow-xl p-8 lg:p-12 relative overflow-hidden">
                <!-- Decorative element -->
                <div class="absolute top-0 right-0 w-24 h-24 bg-accent-mint/20 rounded-bl-full -mr-12 -mt-12"></div>

                <form action="{{ route('categories.store') }}" method="POST" class="relative">
                    @csrf
                    <div class="space-y-8">
                        <div>
                            <label for="name"
                            ...
                            <input id="name" name="name" type="text"
                                ...
                                placeholder="e.g. Science Fiction, Classical Literature..." value="{{ old('name') }}"
                                required>
                        ...
                        <div
                            ...
                            Elevating the organization of knowledge.
                        </div>
